...
def homepage(request):
    return render(request=request, template_name='authenticate/home.html')
...
def register_request(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("authenticate:homepage")
...
def logout_request(request):
    ...
    return render(request=request, template_name="authenticate/logout.html")
